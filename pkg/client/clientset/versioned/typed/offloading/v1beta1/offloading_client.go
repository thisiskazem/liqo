...
func (c *OffloadingV1beta1Client) NamespaceMaps(namespace string) NamespaceMapInterface {
...
func (c *OffloadingV1beta1Client) VkOptionsTemplates(namespace string) VkOptionsTemplateInterface {
	return newVkOptionsTemplates(c, namespace)
}

// NewForConfig creates a new OffloadingV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new OffloadingV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*OffloadingV1beta1Client, error) {
	...
	return &OffloadingV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new OffloadingV1beta1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *OffloadingV1beta1Client {
...
// New creates a new OffloadingV1beta1Client for the given RESTClient.
func New(c rest.Interface) *OffloadingV1beta1Client {
...
func (c *OffloadingV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
